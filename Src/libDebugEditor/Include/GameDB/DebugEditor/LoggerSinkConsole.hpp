#ifndef GDB_LIB_DEBUG_EDITOR_LOGGER_SINK_CONSOLE_HPP
#define GDB_LIB_DEBUG_EDITOR_LOGGER_SINK_CONSOLE_HPP
...
#endif // !GDB_LIB_DEBUG_EDITOR_LOGGER_SINK_CONSOLE_HPP
