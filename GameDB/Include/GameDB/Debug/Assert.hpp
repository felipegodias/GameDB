...
#else // NDEBUG
#define GAME_DB_ASSERT(expr, msg) if (static_cast<bool>((expr))) { Pluto::GameDB::Assert::OnAssertionFailed(#expr, __FILE__, __LINE__, static_cast<const char*>(__FUNCTION__), (msg)); std::abort(); } void(0)
#endif // NDEBUG
